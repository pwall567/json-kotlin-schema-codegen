...
The latest version of the library is 0.122, and it may be obtained from the Maven Central repository.
...
### Gradle
```groovy
    implementation 'net.pwall.json:json-kotlin-schema-codegen:0.122'
```
### Gradle (kts)
```kotlin
    implementation("net.pwall.json:json-kotlin-schema-codegen:0.122")
