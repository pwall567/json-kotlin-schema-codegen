...
class PhoneContact(
    ...
    override fun toString() = "PhoneContact(base=$base, contactType=$contactType, countryCode=$countryCode, localNumber=$localNumber)"
    ...
    ) = PhoneContact(base, contactType, countryCode, localNumber)
