/*
 * TestAdditionalPropertiesTrueExtra.kt
 *
...
/**
 * Test use of additionalProperties true with extra fields.
 */
class TestAdditionalPropertiesTrueExtra(
    ...
    override fun toString() = buildString {
        append("TestAdditionalPropertiesTrueExtra(")
    ...
    override fun equals(other: Any?): Boolean = this === other || other is TestAdditionalPropertiesTrueExtra && cg_map == other.cg_map
