...
class PhoneContact(
    ...
    override fun toString() = "PhoneContact(extraProperty=$extraProperty, contactType=$contactType, countryCode=$countryCode, localNumber=$localNumber)"
    ...
    ) = PhoneContact(extraProperty, contactType, countryCode, localNumber)

    operator fun component3() = countryCode

    operator fun component4() = localNumber
