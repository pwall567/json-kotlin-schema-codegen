/*
 * TestAdditionalPropertiesSchemaExtra.kt
 *
...
/**
 * Test use of additionalProperties with schema with extra fields.
 */
class TestAdditionalPropertiesSchemaExtra(
    ...
    init {
        ...
        cg_map.entries.forEach { (key, value) ->
            if (key != "extra")
                require(value is LocalDate) { "$key is not the correct type, expecting LocalDate" }
        }
    }
